...
def answer_question(run_dir: str, question: str) -> Tuple[str, str, Dict[str, Any], float]:
    ...
    if intent == "summary":
        ...
        if stats:
            ...
            if windows:
                ...
                parts.append(f"high_density_windows=0 (threshold={threshold})")
    ...
    return (
        "unknown",
        "I can answer questions about counts, peak crowd, crowded windows, timeline, and enter/exit events. "
        "Try: 'How many people?', 'When was the peak crowd?', 'When was it crowded?', 'Give me a summary'.",
        {"supported_intents": ["count_people", "peak_people", "crowd_windows", "timeline_info", "events", "summary"]},
        0.4
    )
